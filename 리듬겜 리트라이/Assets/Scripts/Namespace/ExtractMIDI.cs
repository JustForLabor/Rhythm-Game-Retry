...
namespace RhythmGame.Midi
{
     class ExtractMIDI : MonoBehaviour
    {
        //======================================== MIDI 추출물 저장 변수 ============================================

        public NoteData NoteData; // {get; private set;} // NoteData 클래스

        //======================================== 기본 설정 변수 ============================================

        [SerializeField] string midiFilePath; // Midi파일 이름
        [SerializeField] Vector2 notePositionOffset; // 노트 위치 오프셋
        [SerializeField] KeyCode[] inputKeys = new KeyCode[2]; // 플레이어 노트 입력키
